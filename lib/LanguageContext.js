...
const translations = {
  uz: {
    ...
    examTitle: "Konuşma Sınavı",     // This might be kept Turkish for brand or translated. We'll translate UI. Or maybe "Gapirish Sinovi"? Let's translate UI, leave actual exam terms in TR if needed. We'll use "Gapirish Sinovi".
    ...
    loginHeader2: "Konuşma Sınavı",    // Left as brand if desired, but user said "make everything Uzbek". We'll use "Gapirish imtihoni".
    ...
    examSaniye: "soniya",
    examKeyingi: "Keyingi →",
    examLehine: "Ijobiy (Lehinə)",   // Keeping it simple Uzbek or close
    examAleyhine: "Salbiy (Əleyhinə)"
  },
  tr: {
    // Navbar
    navHome: 'Ana Sayfa',
