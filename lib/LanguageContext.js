...
const translations = {
  uz: {
    ...
    // Modules
    modPlacementTitle: 'Daraja aniqlash imtihoni',
    modPlacementDesc: "Turk tili darajangizni (A1-C1) grammatika, o'qish va eshitish savollari orqali aniqlang.",
    modSpeakingTitle: 'Gapirish (Speaking)',
    modSpeakingDesc: "AI emas, haqiqiy o'qituvchi baholaydi",
    modListeningTitle: 'Eshitish (Listening)',
  ...
  tr: {
    ...
    // Modules
    modPlacementTitle: 'Seviye Tespit Sınavı',
    modPlacementDesc: "Türkçe seviyenizi (A1-C1) gramer, okuma ve dinleme sorularıyla anında ölçün.",
...
export function LanguageProvider({ children }) {
  const [lang, setLang] = useState(() => {
    ...
    return saved === 'uz' || saved === 'tr' ? saved : 'uz';
  });
