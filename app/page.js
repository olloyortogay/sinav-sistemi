...
export default function LandingPage() {
  ...
  const examModules = [
    { 
      ...
      desc: 'Ovozli javoblar va AI tahlili', 
      icon: '🎤', 
      active: true, 
      path: '/exam/speaking',
      color: 'blue'
    ...
    { 
      id: 'listening', 
      title: 'Eshittirish (Listening)', 
      desc: 'Audio tahlil va tushunish', 
      icon: '🎧', 
      active: false, 
      color: 'gray'
    },
    { 
      id: 'reading', 
      title: 'O\'qish (Reading)', 
      desc: 'Matn tahlili va savollar', 
      icon: '📖', 
      active: false, 
      color: 'gray'
    },
      ...
      <section className="relative pt-12 pb-20 sm:pt-20 sm:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-blue-50 px-4 py-1.5 rounded-full mb-8 border border-blue-100 animate-fade-in">
            ...
            <span className="text-xs font-bold text-blue-700 tracking-wider uppercase">Türk Dünyası Standartıda</span>
          </div>

          <h1 className="text-5xl sm:text-7xl font-extrabold text-gray-900 mb-6 tracking-tight">
            Til Bilish Darajangizni <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-emerald-500">Sifatli Aniqlang</span>
          </h1>
          
          <p className="max-w-2xl mx-auto text-lg text-gray-600 mb-10 leading-relaxed">
            Zamonaviy AI teknolojisi yordamida nutq, eshitish va yozish ko'nikmalaringizni 
            Türk Dünyası me'yorlari asosida tekshiring.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-white sm:rounded-[3rem] shadow-sm border border-gray-50">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
          <div className="text-left">
            <h2 className="text-3xl font-extrabold text-gray-900 mb-2">Sınav Modullari</h2>
            <p className="text-gray-500 font-medium">Barcha yo'nalishlarda har tomonlama baholash</p>
          </div>
          ...
          {examModules.map((mod) => (
            <div key={mod.id} className={`group relative p-8 rounded-[2rem] border transition-all duration-300 ${
              ...
              {mod.active ? (
                ...
                <span className="text-gray-400 text-sm font-bold">Tez kunda...</span>
              )}
            </div>
          ))}
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16 items-center">
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Zamonaviy til o'qitish standartlari va <br /> innovate teknolojilar markazi.
              </p>
            </div>

            <div className="flex flex-col items-center gap-4">
              <p className="text-gray-400 font-bold text-xs uppercase tracking-widest mb-2">Biz bilan bog'laning</p>
            ...
            <div className="text-center md:text-right">
              <p className="text-gray-400 text-sm mb-4">Hozirgi barcha sinovlar bepul taqdim etiladi.</p>
          ...
          <div className="border-t border-gray-800 pt-8 text-center">
            <p className="text-gray-500 text-xs tracking-widest font-medium">
              © 2026 TÜRK DÜNYASI PLATFORMASI. BARCHA HUQUQLAR HIMOYA QILINGAN.
            </p>
          </div>
        </div>
      </footer>
